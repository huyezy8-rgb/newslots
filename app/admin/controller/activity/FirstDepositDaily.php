 ...
 * 每日首充配置管理
 */
class FirstDepositDaily extends Backend
{
    /**
     * FirstDepositDaily模型对象
     * @var object
     * @phpstan-var \app\common\model\activity\FirstDepositDaily
     */
    ...
    {
        parent::initialize();
        $this->model = new \app\common\model\activity\FirstDepositDaily();
    }
