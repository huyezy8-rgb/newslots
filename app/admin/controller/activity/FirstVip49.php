 ...
 * VIP独有充值配置管理
 */
class FirstVip49 extends Backend
{
    /**
     * FirstVip49模型对象
     * @var object
     * @phpstan-var \app\common\model\activity\FirstVip49
     */
    ...
    {
        parent::initialize();
        $this->model = new \app\common\model\activity\FirstVip49();
    }
    ...
    public function edit(): void
    {
        ...
        if ($this->request->isPost()) {
            ...
            $jsonFields = ['amount_list', 'pay_channels'];
