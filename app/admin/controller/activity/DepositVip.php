 ...
 * vip充值配置管理
 */
class DepositVip extends Backend
{
    /**
     * Vip模型对象
     * @var object
     * @phpstan-var \app\common\model\activity\DepositVip
     */
    ...
    {
        parent::initialize();
        $this->model = new \app\common\model\activity\DepositVip();
    }
    /**
     * 编辑
     * @throws \Throwable
    ...
    public function edit(): void
    {
        ...
        if ($this->request->isPost()) {
            ...
            $jsonFields = ['amount_list', 'pay_channels', 'reward_value','vip1','vip2','vip3'];
