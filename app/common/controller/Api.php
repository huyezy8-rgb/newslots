...
class Api extends BaseController
{
    ...
    protected function initialize(): void
    {
        ...
        parent::initialize();
        // 获取Facebook Pixel参数
        $this->fbc = Request::header('x-fbc'); // 从header获取fbc
        $this->fbp = Request::header('x-fbp') ?? Request::cookie('_fbp'); // 优先从header获取，其次从cookie获取
        $this->fbclid = Request::header('fbclid'); // 从header获取fbc
        // 加载控制器语言包
