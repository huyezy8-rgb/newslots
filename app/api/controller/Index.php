...
class Index extends Frontend
{
    ...
    public function index(): void
    {
        ...
        if ($this->auth->isLogin()) {
            ...
            if ($requiredLogin) {
                ...
                try {
                    ...
                    $this->error(__('Token expiration'), [], 409); // Token过期
                }

                $this->error(__('Please login first'), [ // 请先登录
        ...
        $banner = get_sys_config('carousel_banner') ?: '';
        $banner = $banner ? explode(',', $banner) : [];
        $banner = array_map(fn($path) => full_url().$path, $banner);
        ...
        $this->success('', [
            'site'             => [
                ...
                'timezone'     => [
                    'default' => Config::get('app.default_timezone'),
                    'system'  => get_sys_config('time_zone'),
