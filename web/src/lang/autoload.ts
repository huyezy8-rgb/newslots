...
export default {
    ...
    [adminBaseRoutePath + '/account/account_coin_log']: ['./backend/${lang}/account/coinLog.ts'],
    [adminBaseRoutePath + '/account/account_coin_log/index']: ['./backend/${lang}/account/coinLog.ts'],
}
