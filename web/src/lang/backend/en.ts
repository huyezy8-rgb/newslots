...
export default {
    ...
    '下注金额': 'Bet Amount',
    '返奖金额': 'Reward Amount',
    '每日注册+往日活跃人数': 'Daily Registration + Previous Active Users',
    '当日付费人数': 'Daily Paid Users',
    '付费人数/DAU': 'Paid Users / DAU',
    '当日付费总额': 'Daily Total Payment',
    '平均每用户收入': 'Average Revenue Per User',
    '平均每付费用户收入': 'Average Revenue Per Paid User',
    '当日提现总额': 'Daily Total Withdrawal',
    '提现用户数/DAU': 'Withdrawal Users / DAU',
    '当日下单总额': 'Daily Total Order',
    '当日返奖总额': 'Daily Total Reward',
    '用户价值指标': 'User Value Metrics',
    '提现指标': 'Withdrawal Metrics',
    '交易指标': 'Transaction Metrics',
    '详细数据': 'Detailed Data',
    '指标': 'Metric',
    '数值': 'Value',
    '说明': 'Description',
    '当日注册用户': 'Daily Registered Users',
    '当日活跃用户': 'Daily Active Users',
    '当日新注册用户数': 'Daily New Registered Users',
    '当日登录游戏用户数': 'Daily Game Login Users',
    '当日付费用户数': 'Daily Paid Users',
    '当日提现用户数': 'Daily Withdrawal Users',
    '当日下注数量': 'Daily Bet Count',
    '数据趋势': 'Data Trends',
    'TODO: 这里将展示数据趋势图表': 'TODO: Data trend charts will be displayed here',
    '包括DAU趋势、付费率趋势、ARPU趋势等': 'Including DAU trends, payment rate trends, ARPU trends, etc.',
    // LTV statistics related
    'LTV统计': 'LTV Statistics',
    '用户生命周期价值': 'User Lifetime Value',
    'LTV-1': 'LTV-1',
    'LTV-2': 'LTV-2',
    'LTV-3': 'LTV-3',
    'LTV-4': 'LTV-4',
    ...
    'LTV-29': 'LTV-29',
    'LTV-30': 'LTV-30',
    '累计收入': 'Cumulative Revenue',
    '注册用户数': 'Registered Users',
    '平均每用户累计收入': 'Average Cumulative Revenue Per User',
    layouts: {
